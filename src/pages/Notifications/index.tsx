...
import { IconBell, IconCheck, IconUserPlus } from '@tabler/icons-react'
    ...
    <div className="max-w-2xl mx-auto flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h1 className="flex items-center gap-2 text-xl font-bold text-white">
          <IconBell className="w-5 h-5 text-brand-400" />
          Bildirimler
        </h1>
      ...
      {pendingRequests.length > 0 && (
        <div className="card overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-surface-border bg-surface-raised">
            <IconUserPlus className="w-4 h-4 text-yellow-400" />
      ...
      {filtered.length === 0 ? (
        <div className="card p-12 text-center text-gray-500">
          <IconBell className="w-10 h-10 mx-auto mb-3 text-gray-700" />
