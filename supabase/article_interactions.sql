-- ================================================================
-- Makale Etkileşim Tabloları  (idempotent — tekrar çalıştırılabilir)
-- ================================================================
...
drop policy if exists "Herkes görebilir"              on public.article_likes;
drop policy if exists "Giriş yapanlar beğenebilir"    on public.article_likes;
drop policy if exists "Kendi beğenisini kaldırabilir" on public.article_likes;
...
drop policy if exists "Herkes görebilir"            on public.article_saves;
drop policy if exists "Giriş yapanlar kaydedebilir" on public.article_saves;
drop policy if exists "Kendi kaydını kaldırabilir"  on public.article_saves;
...
drop policy if exists "Herkes görebilir"              on public.article_comments;
drop policy if exists "Giriş yapanlar yorum yapabilir" on public.article_comments;
drop policy if exists "Kendi yorumunu silebilir"       on public.article_comments;
...
drop policy if exists "Herkes görebilir"          on public.collection_articles;
drop policy if exists "Koleksiyon sahibi yönetebilir" on public.collection_articles;
